...
items.append(Item('eq_minesh1', 'BOXI_ENEMY_BUFF_EQUIP'))
items.append(Item('eq_minesh2', 'BOXI_ENEMY_BUFF_EQUIP'))
items.append(Item('eq_soncdt1', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_soncdt2', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_burn1', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_burn2', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_firesu1', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('et_firesu1', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_minefr', 'BOXI_ENEMY_SPELL_WEAPON'))
items.append(Item('eq_minecb', 'BOXI_ENEMY_SPELL_WEAPON'))
