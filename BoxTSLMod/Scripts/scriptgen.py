...
scripts.append(Script.new_forceaoeattack('box_masslevitate', 'Mass Levitation', 10.0, 'SHAPE_SPHERE', '21', 'Box_LevitatePower', 'GetLocation(OBJECT_SELF)', 'Box_NoVisual', 'POWER_TYPE_UNIVERSAL'))
...
scripts.append(Script.new_grenade('box_thermaldet', 4.0, 'Box_DetonatorGrenade', 'Box_DetonatorGrenadeExplode'))
...
scripts.append(Script.new_grenade('box_gasgrenla', 4.0, 'Box_PoisonGrenadeLauncher', 'Box_GasGrenadeExplode'))
...
scripts.append(Script.new_grenade('box_thermaldetla', 4.0, 'Box_DetonatorGrenadeLauncher', 'Box_DetonatorGrenadeExplode'))
...
scripts.append(Script.new_mine('box_fragmine1', 3.5, 1, 'Box_FragMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_fragmine2', 3.5, 2, 'Box_FragMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_fragmine3', 3.5, 3, 'Box_FragMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_fragmine4', 3.5, 4, 'Box_FragMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_fragmine5', 3.5, 5, 'Box_FragMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_flashmine1', 3.5, 1, 'Box_FlashMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_flashmine2', 3.5, 2, 'Box_FlashMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_flashmine3', 3.5, 3, 'Box_FlashMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_flashmine4', 3.5, 4, 'Box_FlashMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_flashmine5', 3.5, 5, 'Box_FlashMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_gasmine1', 3.5, 1, 'Box_PoisonMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_gasmine2', 3.5, 2, 'Box_PoisonMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_gasmine3', 3.5, 3, 'Box_PoisonMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_gasmine4', 3.5, 4, 'Box_PoisonMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_gasmine5', 3.5, 5, 'Box_PoisonMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_sonicmine1', 3.5, 1, 'Box_SonicMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_sonicmine2', 3.5, 2, 'Box_SonicMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_sonicmine3', 3.5, 3, 'Box_SonicMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_sonicmine4', 3.5, 4, 'Box_SonicMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_sonicmine5', 3.5, 5, 'Box_SonicMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_plasmamine1', 3.5, 1, 'Box_PlasmaMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_plasmamine2', 3.5, 2, 'Box_PlasmaMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_plasmamine3', 3.5, 3, 'Box_PlasmaMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_plasmamine4', 3.5, 4, 'Box_PlasmaMine', 'Box_NoVisual'))
scripts.append(Script.new_mine('box_plasmamine5', 3.5, 5, 'Box_PlasmaMine', 'Box_NoVisual'))
...
scripts.append(Script.new_spawn('bx_mindrd2', 'Box_MiningDroidMarkII', 'box_inc_spawn_per', 'k_def_spawn01'))
scripts.append(Script.new_spawn('bx_mindrd2_fr', 'Box_MiningDroidMarkIIFire', 'box_inc_spawn_per', 'k_def_spawn01'))
scripts.append(Script.new_spawn('bx_mindrd2_cd', 'Box_MiningDroidMarkIICold', 'box_inc_spawn_per', 'k_def_spawn01'))
scripts.append(Script.new_spawn('bx_mindrd2_ex', 'Box_ExcavatorDroidMarkII', 'box_inc_spawn_per', 'k_def_spawn01'))
